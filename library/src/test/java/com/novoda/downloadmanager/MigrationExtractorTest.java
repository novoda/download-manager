...
public class MigrationExtractorTest {
    ...
    private static final StorageRoot STORAGE_ROOT = TestStorageRootFactory.create();
    ...
    @Before
    public void setUp() {
        migrationExtractor = new MigrationExtractor(STORAGE_ROOT, database, filePersistence, "base");
    }
