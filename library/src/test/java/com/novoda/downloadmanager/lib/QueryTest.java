...
public class QueryTest {
    ...
    public void givenBatchIdsWhenTheQueryIsCreatedThenTheWhereStatementIsCorrect() {
        ...
        assertThat(stringArgumentCaptor.getValue()).contains(DownloadsContract.COLUMN_BATCH_ID + " IN (1,2,3)");
    }
    ...
    public void givenNoBatchIdsWhenTheQueryIsCreatedThenTheWhereStatementContainsNoBatchIdPredicate() {
        ...
        assertThat(stringArgumentCaptor.getValue()).doesNotContain(DownloadsContract.COLUMN_BATCH_ID + " IN ");
    }
